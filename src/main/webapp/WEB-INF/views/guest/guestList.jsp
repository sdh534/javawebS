...
<div class="container">
  ...
  <div class="text-center">
	  <ul class="pagination justify-content-center">
	    ...
	    <c:if test="${pageVO.curBlock > 0}"><li class="page-item"><a class="page-link text-secondary" href="${ctp}/guest/guestList?pageSize=${pageVO.pageSize}&pag=${(pageVO.curBlock-1)*blockSize + 1}">이전블록</a></li></c:if>
